...
export default <CalculatorApp></CalculatorApp*/
...
function CalculatorApp() {
    ...
    return(
        <div className='calculator'>
            <input type="text" value={result} disable />
               
        <div className='buttons'>
 
            <button className='clear' onClick={clear}>AC</button>
            <button className='clear' onClick={deleteEl}>DE</button>

            <button id='.' className='clear' onClick={handleClick}>.</button>
